...
Router.route('/schools/select', {
  waitOn: function () {
    return Meteor.subscribe('schoolnames');
  },
  action: function () {
    this.render('search');
...
Router.route('/school/:_schoolId/version/:_id/survey/section/select', {
  name: 'survey',
  waitOn: function () {
    return [Meteor.subscribe('schoolnames', this.params._schoolId), Meteor.subscribe('surveyVersions', this.params._id)];
  },
  action: function () {
...
Router.route('/school/:_schoolId/version/:_versionId/survey/:_surveySection', {
  ...
  name: 'surveySection',
  waitOn: function () {
    console.log(this.params._versionId);
